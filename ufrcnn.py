...
from utils.model_utils import batch_dice
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_dir', type=str, default='/shenlab/lab_stor6/yuezhou/ABUSdata/mrcnn/debug_dice/',
    ...
    #parser.add_argument('--resume_to_checkpoint', type=str, default='/shenlab/lab_stor6/yuezhou/ABUSdata/mrcnn/compare/0623_vlevel4/fold_1/last_checkpoint/',
